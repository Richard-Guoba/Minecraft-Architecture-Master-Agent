...
function provenance() { return { corpus_sha256: 'c'.repeat(64), rule_version: '0.1.0', generator_commit: COMMIT, minecraft_version: '1.21.9', options: { ...OPTIONS } }; }
...
function authority(value) { value.authority_stat = { is_regular_file: true, is_symlink: false, size: 1 }; return value; }
