const DOOR_VARIANTS = [
  {
    id: 'south-entry',
    side: 'south',
    text: '门在南侧，门外要有能从外界看见的直达步道'
  },
  {
    id: 'east-entry',
    side: 'east',
    text: '门在东侧，门外要有能从外界看见的直达步道'
  },
  {
    id: 'north-entry',
    side: 'north',
    text: '门在北侧，门外要有能从外界看见的直达步道'
  },
  {
    id: 'west-entry',
    side: 'west',
    text: '门在西侧，门外要有能从外界看见的直达步道'
  }
];
...
const HABITATION_CASES = [
  ...
  caseItem('industrial-loft-home', ['industrial', 'loft', 'workshop'], '建一个工业风两层 loft 住宅，宽29深21，一间卧室，一个卫生间，开放客厅，厨房，餐厅，工作间，楼梯和储藏间，大窗采光但入口清楚'),
  ...
  caseItem('treehouse-home', ['treehouse', 'raised', 'vertical-core'], '建一个树屋风格两层住宅，宽23深23，一间卧室，一个卫生间，客厅，厨房，小餐区，楼梯，观景平台和储藏间，入口路径要接到树屋平台'),
  ...
  caseItem('nordic-cabin-home', ['nordic', 'cabin', 'compact'], '建一个北欧两层小木屋，宽19深17，一间卧室，一个卫生间，起居室，餐厨一体，楼梯，储藏间和小书桌，窗户采光且入口容易识别'),
  caseItem('fortified-bunker-home', ['fortified', 'bunker', 'utility'], '建一个半地下防御住宅，宽29深23，两间卧室，一个卫生间，入口缓冲间，客厅，厨房，工作间，设备间和储藏间，厚墙但内部要连通'),
  caseItem('european-family-villa', ['european', 'villa', 'large'], '建一个欧式三层家庭别墅，宽39深29，四间卧室，三个卫生间，门厅，客厅，餐厅，厨房，书房，楼梯，车库和储藏间，主入口要非常明确'),
  ...
  caseItem('ranch-family-house', ['ranch', 'wide', 'single-floor'], '建一个牧场风一层宽住宅，宽33深19，三间卧室，两个卫生间，门厅，客厅，厨房，餐厅，储藏间，洗衣间和长廊，入口路径清楚'),
...
export const HABITATION_EVALUATION_PROMPTS = HABITATION_CASES.flatMap((item, caseIndex) =>
  DOOR_VARIANTS.map((door, doorIndex) => ({
    ...
    prompt: `${item.prompt}，${door.text}。要求作为人类居住的房子必须外壳完整密闭、屋顶覆盖、主入口可达、室内房间彼此连通、有采光和照明。`
  }))
);
