...
export class MaterialPaletteAgent {
  run(prompt = '', architecture = {}, stylePreset = {}) {
    ...
    const repaired = repairInvalidMaterials(normalizeMaterials({
      ...
      earth: extras.earth || base.earth || 'minecraft:dirt',
      grass: extras.grass || extras.landscape || base.grass || 'minecraft:grass_block',
      path_secondary: extras.path_secondary || base.path_secondary || extras.retaining || base.foundation || 'minecraft:cobblestone',
      garden_edge: extras.garden_edge || base.garden_edge || extras.railing || base.trim || 'minecraft:oak_fence',
