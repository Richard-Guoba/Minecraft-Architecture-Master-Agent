...
PAPER = {
    ...
    "sections": [
        ...
        },
        {
            "heading": "AI 辅助说明",
            "paragraphs": [
                "本项目合理使用 AI 工具辅助开发和文档整理，人类与 AI 的分工明确：小组成员提出项目 idea、应用场景、功能目标、prompt 需求和结果判断标准，并负责系统边界、架构取舍、运行调试、测试执行、截图确认和最终提交整合；AI 工具根据这些想法执行落地工作，包括代码修改建议、文档初稿整理、报告润色、测试清单、网页排版检查和重复性格式调整。最终方案、运行结果和提交内容均由小组确认，报告和网站中的运行截图来自 Minecraft 游戏内真实结果。"
            ],
        },
        {
            "heading": "参考资料",
