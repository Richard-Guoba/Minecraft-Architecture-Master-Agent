...
- Recorded code revision: `77319bae5798097a8127c32a0ca89a645d43fdb7`.
...
Result: exit `0`. The canonical output is ignored at `training/stage7/runs/m3-acceptance/acceptance.json`; its SHA-256 is `7c357f406ae9a10513bbc4b18b5daf668e8e8d08aa3b6a39fdd9587e47648c9e`.
...
| Checkpoint manifest | `bca82317c22750cc8075e15151b24369e8f030013dd81665038102b9fe43b244` |
...
| Command | Result |
| --- | --- |
| `conda run -n mcagent-stage7 --cwd training/stage7 python -m pytest -q -p no:cacheprovider tests/test_acceptance.py` | `16` passed; includes gate drift, all training/inference mismatch classes, invalid Node results, and primary-operation drift |
| `npm run test:stage7:m3` | `181` passed, `0` failed |
